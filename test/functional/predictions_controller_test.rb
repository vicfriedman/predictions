...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { deadline: @prediction.deadline, email: @prediction.email, prediction: @prediction.prediction }
    end
  ...
  test "should update prediction" do
    put :update, id: @prediction, prediction: { deadline: @prediction.deadline, email: @prediction.email, prediction: @prediction.prediction }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
